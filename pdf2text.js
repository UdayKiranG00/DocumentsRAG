...
import { GlobalWorkerOptions,getDocument, OPS } from "./node_modules/pdfjs-dist/webpack.mjs"; // ESM import
...
await extractTextFromImage(outputDir+'image_'+index+'.png',textFilePath);
}
}
